     ...
     else
     {
         ...
         if (isset($_POST["submit"]) && isset($_FILES["fileToUpload"])){
             ...
             else
             {
                 ...
                 {
                     echo $imgErr = "抱歉,僅支援 JPG,JPEG,PNG &GIF 的圖片格式上傳";
                     echo "<br>";
                     $uploadOk = 0;
                     header("location:addContact.php?imgErr=$imgErr");
                 }
                 ...
                 if ($uploadOk ==0)
                 {
                     echo $FailedUpload= "抱歉，您所上傳的檔案並未上傳，請重新操作!";
